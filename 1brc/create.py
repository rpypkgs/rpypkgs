...
# Based on https://github.com/ifnesi/1brc/blob/main/createMeasurements.py
...
for i in range(1000 * 1000 * 1000):
    station, average = random.choice(STATIONS)
    sample = random.gauss(average, 10.0)
    print("%s;%.1f" % (station, sample))
